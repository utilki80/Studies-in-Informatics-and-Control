...
global node c b Fai 
node=7;
c=0.1*[-1.5 -1 -0.5 0 0.5 1 1.5;-1.5 -1 -0.5 0 0.5 1 1.5;-1.5 -1 -0.5 0 0.5 1 1.5;-1.5 -1 -0.5 0 0.5 1 1.5;-1.5 -1 -0.5 0 0.5 1 1.5];
b=10;
%cm = [71.8192 31.5546 66.7242 5.4640 92.0241 6.2275 49.6647];
%c = [cm;cm;cm;cm;cm];
%b = 60.3067;
Fai=35*eye(2);
%Fai=57.9426*eye(2);
